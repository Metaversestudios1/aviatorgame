...
useEffect(() => {
  ...
  return (
    <div className="game-container rounded-lg relative md:w-[73vw]">
      {/* <div className="game-screen"> */}
        <div
          className="game w-[72vw]"
          ref={gameRef}
        ...
        <div className="bet flex justify-center items-center md:w-[72vw]">
          {/* <input
            type="number"
            value={betAmount}
          ...
          <div className="bg-[#191A1B] md:w-1/2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="bg-[#28A909] w-full h- rounded-lg p-3 text-xl font-semibold text-white">Bet</button>
          </div>
          </div>
          <div className="bg-[#191A1B] md:w-1/2">
          <div className="w-full flex justify-center my-2">
