...
function ResetOtpScreen() {
  ...
  return (
    <div className='bg-[url("./assets/images/forgot_password/bg.png")] bg-cover bg-no-repeat h-screen w-screen flex justify-center items-center'>
     {
        verify ? (<ResetBox />) : <div className=" bg-[rgba(0,0,0,0.7)] flex flex-col justify-center items-center p-4 rounded-xl gap-6 px-10">
        ...
        <button className="bg-red-600 hover:bg-red-500 text-white p-3 font-bold my-2 rounded-lg w-full" onClick={()=>setVerify(true)}>
          Continue
        </button>
